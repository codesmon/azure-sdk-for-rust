...
use crate::clients::{
    sas_token_policy::create_sas_token_policy, QueueClient, QueueServiceClientOptions,
};
use crate::generated::clients::QueueServiceClient as GeneratedQueueClient;
use crate::models::*;
...
use azure_core::{
    ...
    http::{
        ...
        ClientOptions, Context, Method, NoFormat, PageIterator, RawResponse, Request,
        RequestContent, Response, StatusCode, Url, XmlFormat,
    },
    xml, Bytes, Result,
};
...
impl QueueServiceClient {
    ...
    /// Creates a new QueueServiceClient using SAS Token.
    ///
    /// # Arguments
    ///
    /// * `endpoint` - The full URL of the Azure storage account, for example `https://<storage_account_name>.queue.core.windows.net/`
    ...
    pub fn from_sas_token(
        ...
        let options = Some(QueueServiceClientOptions {
        ...
        let client = GeneratedQueueClient::with_no_credential(endpoint, options)?;
